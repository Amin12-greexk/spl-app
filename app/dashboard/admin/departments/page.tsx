      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="block md:hidden">
          {departments.map((department) => {
            ...
            return (
              <div key={department.id} className={`p-4 border-b border-gray-100 last:border-b-0 space-y-3 ${isEditing ? "bg-green-50" : "hover:bg-gray-50"}`}>
                <div className="flex items-start justify-between">
                  <div className="font-medium text-gray-900">{department.name}</div>
                  <span className={`px-2 py-1 text-[10px] font-medium rounded-full ${getStatusBadge(department.supervised)}`}>
        ...
        <div className="hidden md:block overflow-x-auto">
          <table className="min-w-[520px] w-full whitespace-nowrap">
